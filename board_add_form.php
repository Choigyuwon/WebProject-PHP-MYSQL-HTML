...
<html>
    ...
    <body>
        <h1 class="display">Board Add</h1>
        <!-- board_add_action.php로 넘기는 폼 -->
        <form class="form-horizontal" action="/boad/board_add_action.php" method="post">
            ...
            <div class="form-group">
                <label for="exampleInputTitle1" class="col-sm-2 control-label">Title</label>
                <div class="col-sm-10">
                    <!-- 글 제목 입력 상자 -->
            ...
            <div class="form-group">
                <label for="exampleInputContent1" class="col-sm-2 control-label">Contents</label>
                <div class="col-sm-10">
                    <!-- 글 내용 입력 텍스트영역 -->
            ...
            <div class="form-group">
                <label for="exampleInputName1" class="col-sm-2 control-label">Writer</label>
                <div class="col-sm-10">
                    <!-- 작성자명 입력 상자 -->
            ...
            <div>
                &nbsp;&nbsp;&nbsp;
                <!-- 글 입력 버튼 --><br>
                <button class="btn-style" type="submit" value="Input">Input</button>
                &nbsp;&nbsp;
                <!-- 입력 내용 초기화 버튼 -->
                <button class="btn-style" type="reset" value="reset">Reset</button><br>
                &nbsp;&nbsp;<br>
                <!-- 리스트로 돌아가는 버튼 -->
                <a class="btn-style" href="/boad/board_list.php">ComeBackList</a>
            </div>
        </form>
